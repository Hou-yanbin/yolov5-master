...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default='firedata666/fire666.yaml', help='dataset.yaml path')
    # parser.add_argument('--data', type=str, default='yolov5fire/VOCdevkit/fire.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default='runs/train/exp71/weights/last.pt', help='model.pt path(s)')
