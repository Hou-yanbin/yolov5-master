...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default='Apple_data/apple.yaml', help='dataset.yaml path')
    # parser.add_argument('--data', type=str, default='yolov5fire/VOCdevkit/fire.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default='runs/train/exp45/weights/best.pt', help='model.pt path(s)')
